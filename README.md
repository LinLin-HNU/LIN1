#  AI驱动的智能餐饮交易与客服系统（Spring AI + 微服务架构）

> **一站式智能餐饮交易与客服系统** — 面向餐饮场景构建智能交易平台，在传统点餐系统基础上集成大模型客服，实现订单咨询、菜品推荐、多轮问答等能力。
...
|  **Knife4j 接口文档** | 前后端分离开发，自动生成 Swagger 风格 API 文档，支持在线调试 |
|  **阿里云 OSS 文件存储** | 菜品图片等静态资源统一上云，减轻服务器压力，保障高可用 |
